...
fun NearbyButton(
    ...
    Button(
        ...
        Row (
            ...
            iconRes?.let { Icon(painter = painterResource(id = iconRes), contentDescription = "Button Icon") }
...
private fun NearbyButtonPreview() {
    NearbyButton(modifier = Modifier.fillMaxWidth(), text = "Confirm Button", iconRes = R.drawable.ic_scan) {}
}

@Preview
@Composable
private fun NearbyButtonNoTextPreview() {
    NearbyButton(modifier = Modifier, iconRes = R.drawable.ic_scan) {}
}

@Preview
@Composable
private fun NearbyButtonNoIconPreview() {
    NearbyButton(modifier = Modifier.fillMaxWidth(), text = "Confirm") {}
}